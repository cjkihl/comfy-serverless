...
# Define the directory for custom nodes (parent directory of scripts/)
custom_nodes_dir = os.path.join(
    os.path.dirname(os.path.dirname(os.path.realpath(__file__))), "custom_nodes"
)
...
get_repo("https://github.com/ltdrdata/ComfyUI-Impact-Subpack.git")
get_repo(
...
#     subprocess.run(
#         ["rm", "-rf", "/comfy/custom_nodes/ComfyUI_FaceAnalysis/dlib"], check=True
#     )
...
#             "-s",
#             "/comfy/models/dlib",
#             "/comfy/custom_nodes/ComfyUI_FaceAnalysis/dlib",
#         ],
#         check=True,
#     )
