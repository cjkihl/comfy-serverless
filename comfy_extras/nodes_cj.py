    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "name": (get_folder_names(os.path.join(INSIGHTFACE_MODELS_DIR,'models')), ), 
            },
        }
